...
<section class="presence-dashboard" aria-labelledby="dashboard-heading">
  ...
  <div class="presence-dashboard-grid">
    <section class="presence-section" aria-labelledby="activity-heading">
      <div class="presence-section__heading">
    ...
    <section class="presence-section" aria-labelledby="languages-heading">
      <div class="presence-section__heading">
  ...
  <div class="presence-dashboard-grid">
    <section class="presence-section" aria-labelledby="domains-heading">
      <div class="presence-section__heading">
        <h2 id="domains-heading">Managed Domains</h2>
